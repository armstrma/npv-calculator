      ...
      {showGuideModal && (
        <div className="modal" onClick={() => setShowGuideModal(false)}>
          <div className="modal-content guide-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <BlockMath math={String.raw`NPV = -I_0 + \sum_{t=1}^{n} \frac{CF_t}{(1+r)^t}`} />
            ...
            <BlockMath math={String.raw`0 = -I_0 + \sum_{t=1}^{n} \frac{CF_t}{(1+IRR)^t}`} />
            <p>In practice, compare IRR to the discount rate or hurdle rate to judge whether the return clears your standard.</p>
            ...
            <BlockMath math={String.raw`\text{Discounted Cash Flow at time } t = \frac{CF_t}{(1+r)^t}`} />
            ...
            <BlockMath math={String.raw`ROI = \frac{\text{Total Cash Inflows} - I_0}{I_0} \times 100\%`} />
            <p><strong>PI (Profitability Index)</strong> shows value created per dollar invested.</p>
            <BlockMath math={String.raw`PI = \frac{NPV + I_0}{I_0}`} />
            <p>If <InlineMath math={String.raw`PI > 1`} />, the project is creating value.</p>
